...
(
    ...
    CONSTRAINT fk_submissions_linksetid FOREIGN KEY (linksetid) REFERENCES linksets (id) ON DELETE RESTRICT ON UPDATE CASCADE
);
...
COMMENT ON COLUMN submissions.linksetid is 'ID do conjunto de links';
